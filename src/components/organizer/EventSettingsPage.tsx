            ...
            <div>
                ...
                <div className="mt-4 space-y-4">
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                        ...
                        <select id="visibility" className="border-gray-300 rounded-md shadow-sm">
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                        ...
                        <input id="approval" type="checkbox" className="h-4 w-4 text-indigo-600 border-gray-300 rounded" />
                    </div>
                </div>
            </div>
             <div>
                ...
                <p className="text-gray-600 mt-2">Manage automated email notifications for attendees.</p>
                 <div className="mt-4 space-y-4">
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                        ...
                        <input id="confirmation" type="checkbox" className="h-4 w-4 text-indigo-600 border-gray-300 rounded" defaultChecked/>
                    </div>
                     <div className="flex items-center justify-between p-4 border rounded-lg">
                         <label htmlFor="reminder" className="font-medium text-gray-700">Send 24-hour reminder email</label>
                        <input id="reminder" type="checkbox" className="h-4 w-4 text-indigo-600 border-gray-300 rounded" defaultChecked/>
                    </div>
                </div>
            </div>
